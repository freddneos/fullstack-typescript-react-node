...
const App = () => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "App" },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: () => increment(c + 1) }, "Press here"),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: (prevState) => callApi(prevState) }, "Call API "),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, apiMessage)));
};
